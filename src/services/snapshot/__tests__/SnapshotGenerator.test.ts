...
const official: OfficialMarketOverview = { market: 'TWSE', tradeDate: '2026-07-13', indexName: '發行量加權股價指數', indexValue: 45380.52, change: 25.91, changePercent: .06, tradingAmount: 1067662107060, advanceCount: null, declineCount: null, unchangedCount: null, source: '臺灣證券交易所（TWSE）', sourceUrl: 'https://openapi.twse.com.tw/v1/exchangeReport/MI_INDEX', fetchedAt: '2026-07-14T04:53:38.458Z', status: 'partial', warnings: ['市場廣度不完整'] }
