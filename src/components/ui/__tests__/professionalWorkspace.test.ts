...
describe('交易工作區、決策與行動可存取性契約', () => {
  ...
  it('Sidebar 顯示 v1.0.0 beta 技術選股基礎', () => { expect(sidebar).toContain('GULI v1.0.0-beta.1'); expect(sidebar).toContain('Decision Engine v1.0'); expect(sidebar).toContain('Technical Foundation') })
