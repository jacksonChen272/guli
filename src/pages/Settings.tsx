...
export function Settings() {
  ...
  return (
    <div className="space-y-8">
      <SectionHeader eyebrow="DATA PLATFORM SETTINGS · GULI v1.0.0-beta.3.1" title="資料來源設定" description="公開測試模式會分開揭露 Official、Derived、Mock、Fallback、Stale 與 Missing。"/>
      ...
      <Card title="版本與發布流程" eyebrow="SYSTEM"><div className="grid gap-4 p-5 sm:grid-cols-2 xl:grid-cols-4"><Metric label="GULI" value="v1.0.0-beta.3.1"/><Metric label="GitHub Pages" value="Actions Artifact Deployment"/><Metric label="Data Updates" value="Pull Request Workflow"/><Metric label="Main Protection" value="Automation 不直接寫入 main"/></div></Card>
