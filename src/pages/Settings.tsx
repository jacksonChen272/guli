...
export function Settings() {
  ...
  return (
    <div className="space-y-8">
      <SectionHeader eyebrow="DATA PLATFORM SETTINGS · GULI v0.8.0-beta.1" title="資料來源設定" description="公開測試模式會分開揭露 Official、Derived、Mock、Fallback、Stale 與 Missing。"/>
      ...
      <Card title="版本資訊" eyebrow="SYSTEM"><div className="grid gap-4 p-5 sm:grid-cols-3"><Metric label="GULI" value="v0.8.0-beta.1"/><Metric label="正式資料" value="TWSE 市場／個股／三大法人盤後"/><Metric label="仍為 Mock／Derived" value="技術歷史、部分分析、產業分類"/></div></Card>
    </div>
  )
}
